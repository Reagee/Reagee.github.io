...
<meta property="og:site_name" content="Maksym Gilewski|Portfolio"/>
<meta property="og:description" content="Początkujący Front-end developer z Krakowa, tworzący dla siebie i dla innych. Zapraszam do odwiedzenia mojej storny i zapoznania sie z moimi umiejętnościami."/>
<meta property="og:image" content="thumbnail.png">
<meta property="og:url" content="http://mgilewski.pl/">
<meta name="description" content="Początkujący Front-end developer z Krakowa, tworzący dla siebie i dla innych. Zapraszam do odwiedzenia mojej strony i zapoznania się z moimi umiejętnościami. Freelancer otwarty na wszelkie propozycje. "/>
<meta name="keywords" content="frontend,html,css,js,developer,website,web,www,html5,cracow"/>
...
<body onload="volume()">
	<audio id="music" src="music/bg-music.mp3" type="audio/mpeg" autoplay loop>
	...
	<section id="particles-js">
		...
		<div class="author_logo">
			<img src="images/Logo2.png" alt="author-logo">
		</div>
		...
		<div class="main_bottom_panel">
			<div class="show_more" ><a href="#about"><img src="images/arrow.png" alt="arrow-down"></a></div>
		</div>
	</section>
</section>
</header>
...
.skill-bar-percent {
	...
	<section class="projects_section" id="projects">
		...
		<div class="project">
			<div class="project-left_col">
				...
				<a href="http://www.limitlessgames.pl" target="_blank"><button class="live_button">Live</button></a>
		...
		<div class="project">
			...
			<div class="project-left_col reverse">
				...
				<a href="http://www.wieik.info" target="_blank"><button class="live_button">Live</button></a>
				<button class="github_button">GitHub</button>
				<div style="clear: both;"></div>
				<h5 style="color:green;">Online</h5>
			</div>	
		...
		<div class="project">
			...
			<div class="project-left_col reverse">
				...
				<a href="http://www.gryffindorfoundation.org" target="_blank"><button class="live_button">Live</button></a>
				<button class="github_button">GitHub</button>
				<div style="clear: both;"></div>
				<h5 style="color:green;">Online</h5>
			</div>
			...
			<div class="contact_section-right_col">
				<div class="contact_section-right_col-content">
					...
					<div class="contact_section-socials">
						<div class="contact_section-right_col-content_social fac">
						<a href="https://www.facebook.com/maksym.gilewski" target="_blank"><img src="images/fa.png" alt="fb-icon" width="100" height="100"></a>
						</div>
						
						<div class="contact_section-right_col-content_social gp">
						<a href="https://plus.google.com/u/1/115452132300004127175" target="_blank"><img src="images/g.png" alt="gp-icon" width="100" height="100"></a>
						</div>
						
						<div class="contact_section-right_col-content_social lin">
						<a href="https://www.linkedin.com/in/maksym-gilewski-79b850156/" target="_blank"><img src="images/li.png" alt="lin-icon" width="100" height="100"></a>
						</div>
					</div>
	...
	<footer>
		<div class="footer_logo">
			<img src="images/logo2.png" alt="author-logo" width="150" height="150">
		</div>
